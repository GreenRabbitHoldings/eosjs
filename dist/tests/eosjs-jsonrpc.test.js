...
describe('JSON RPC', function () {
    ...
    it('calls push_ro_transaction', function () { return __awaiter(void 0, void 0, void 0, function () {
        var expPath, signatures, serializedTransaction, expReturn, expParams, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    expPath = '/v1/chain/push_ro_transaction';
                    signatures = [
                        'George Washington',
                        'John Hancock',
                        'Abraham Lincoln',
                    ...
                    fetchMock.once(JSON.stringify(expReturn));
                    return [4 /*yield*/, jsonRpc.push_ro_transaction({ signatures: signatures, serializedTransaction: serializedTransaction })];
                case 1:
                    response = _a.sent();
                    expect(response).toEqual(expReturn);
                    expect(fetch).toBeCalledWith(endpoint + expPath, expParams);
